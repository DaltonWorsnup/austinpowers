...
const UPDATE_CONFIG_FILE = path.join('.config', 'austinpowers', 'update.conf');
...
export const AustinpowersPlugin = async (_context) => {
...
**The \`using-austinpowers\` guidance below is already loaded. Do not load it again.**
