 ...
 * @param {string} superpowersDir - Path to austinpowers skills directory
 * @param {string} personalDir - Path to personal skills directory
 * @returns {{skillFile: string, sourceType: string, skillPath: string} | null}
 */
function resolveSkillPath(skillName, superpowersDir, personalDir) {
    // Strip supported namespace prefix if present.
    const forceSuperpowers = skillName.startsWith('superpowers:') || skillName.startsWith('austinpowers:');
    const actualSkillName = forceSuperpowers
        ? skillName.replace(/^(superpowers|austinpowers):/, '')
        : skillName;
