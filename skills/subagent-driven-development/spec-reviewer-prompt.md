...
Task tool (general-purpose):
  ...
  prompt: |
    ...
    ## Subagent rules
    You are a focused subagent. Do NOT invoke any skills from the austinpowers plugin. Do NOT use the Skill tool. Your only job is the review task described below.
