...
description: >
  ...
  using-austinpowers or executing-plans after implementation.
---
...
3. Dispatch `austinpowers:code-reviewer` using `requesting-code-review/code-reviewer.md`.
4. Provide:
...
For changes involving complex logic, concurrency, state management, or critical data paths, dispatch `austinpowers:red-team` in parallel with the code reviewer.
